...
final class PendingInstallState {
	...
	public function archiveIdentity(): ?array {
		return $this->archiveIdentity; }
	public function receipt(): ?AcquisitionReceipt {
		return $this->receipt; }
	public function extractionAdmitted(): bool {
		return $this->extractionAdmitted; }
	public function installResultCaptured(): bool {
		return $this->installResultCaptured; }
	public function installResult(): mixed {
		return $this->installResult; }
	public function completionObserved(): bool {
		return $this->completionObserved; }
	public function multiRun(): bool {
		return $this->multiRun; }
	/** @return array<string,array{sha256:string,size:int}>|null */
	public function stagedManifest(): ?array {
		return $this->stagedManifest; }
