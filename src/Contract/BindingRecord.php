...
final readonly class BindingRecord
{
    ...
    private const DESCRIPTOR_PAIRS = array(
    ...
    public static function assertDescriptorBinding(IdentityDescriptor $descriptor, self $binding): IdentityDescriptor
    {
        ...
        if ( $facts['artifact_size'] > $binding->facts['maximum_artifact_bytes'] ) {
            throw new InvalidArgumentException('The descriptor exceeds the target artifact limit.');
        }
        return $descriptor;
    }
