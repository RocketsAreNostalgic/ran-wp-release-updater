...
final class IdentityDescriptorTest extends TestCase {
	...
	public function testDescriptorFactsRejectTargetPolicyFields(): void { $facts = $this->facts(); $facts['maximum_artifact_bytes'] = 52428800; $this->expectException( InvalidArgumentException::class ); IdentityDescriptor::create( $facts ); }
