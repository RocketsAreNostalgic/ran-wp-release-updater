...
PHP, array(
	...
	private function releasedProtocolThreeFixture(): string
	{
		...
		self::assertSame( array(
			'package_revision' => '6e305b46ba99898b51bded7266aa9964d88665744928b11162919bf51398ec91', 'package_version' => '0.1.0-beta.3', 'php_floor' => '8.2.0',
	...
	{
		$hashes = array();
		foreach ( array( 'bootstrap.php', 'runtime.php', 'src/Runtime/RequestBroker.php', 'src/Runtime/SelectedRuntimeState.php' ) as $file ) $hashes[ $file ] = hash_file( 'sha256', $root . '/' . $file );
		return $hashes;
	}
