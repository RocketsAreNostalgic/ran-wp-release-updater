...
final class InstalledPackageResolverTest extends TestCase {
	...
	public function testSymlinkedRegisteredRootsAndUnregisteredInternalLinks(): void {
		...
		file_put_contents( $external . '/plugin/main.php', $this->pluginHeader() );
		...
		file_put_contents( $external . '/theme/style.css', $this->themeHeader() );
	...
	public function testThemeIdentityChildParentNestedAndSymlinkBoundaries(): void {
		...
		file_put_contents( $custom . '/custom/style.css', $this->themeHeader() );
	...
	private function pluginHeader( string $suffix = "\n" ): string {
		return "<?php\n/*\nPlugin Name: Example\nVersion: 1.0.0\nUpdate URI: https://github.com/acme/example\n*/" . $suffix; }
	private function themeHeader( string $extra = '' ): string {
		return "/*\nTheme Name: Example\nVersion: 1.0.0\nUpdate URI: https://github.com/acme/example\n" . $extra . "\n*/\n"; }
